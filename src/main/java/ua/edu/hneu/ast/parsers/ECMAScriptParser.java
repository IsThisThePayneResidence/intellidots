...
public class ECMAScriptParser extends Parser {
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(262); expressionSequence();
				}
				break;
			}
			setState(265); eos();
	...
	public final WithStatementContext withStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(267); match(With);
			setState(268); match(OpenParen);
			setState(269); expressionSequence();
			setState(270); match(CloseParen);
	...
	public final SwitchStatementContext switchStatement() throws RecognitionException {
		...
		try {
			...
			setState(274); match(OpenParen);
			setState(275); expressionSequence();
			setState(276); match(CloseParen);
			setState(277); caseBlock();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CaseBlockContext caseBlock() throws RecognitionException {
		...
		try {
			...
			if (_la==Default) {
				{
				setState(283); defaultClause();
				setState(285);
				_la = _input.LA(1);
				if (_la==Case) {
					{
					setState(284); caseClauses();
					}
				}
	...
	public final CaseClauseContext caseClause() throws RecognitionException {
		...
		try {
			...
			setState(297); expressionSequence();
			setState(298); match(Colon);
			setState(300);
			switch ( getInterpreter().adaptivePredict(_input,22,_ctx) ) {
			case 1:
				{
				setState(299); statementList();
				}
				break;
			}
			}
	...
	public final DefaultClauseContext defaultClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(302); match(Default);
			setState(303); match(Colon);
			setState(305);
			switch ( getInterpreter().adaptivePredict(_input,23,_ctx) ) {
			case 1:
				{
				setState(304); statementList();
				}
				break;
			}
			}
	...
	public final ThrowStatementContext throwStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(311); match(Throw);
			setState(312); expressionSequence();
			setState(313); eos();
			}
		}
		catch (RecognitionException re) {
	...
	public final TryStatementContext tryStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(315); match(Try);
				setState(316); block();
				setState(317); catchProduction();
				}
				break;
			...
			case 2:
				...
				setState(320); block();
				setState(321); finallyProduction();
				}
				break;
			...
			case 3:
				...
				setState(324); block();
				setState(325); catchProduction();
				setState(326); finallyProduction();
				}
				break;
			}
		}
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(342); match(Function);
			setState(343); match(Identifier);
			setState(344); match(OpenParen);
			setState(346);
			_la = _input.LA(1);
			if (_la==Identifier) {
				{
				setState(345); formalParameterList();
				}
			}

			setState(348); match(CloseParen);
			setState(349); match(OpenBrace);
			setState(350); functionBody();
			setState(351); match(CloseBrace);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArrayLiteralContext arrayLiteral() throws RecognitionException {
		...
		try {
			...
			if (_la==Comma) {
				{
				setState(371); elision();
				}
			}

			setState(374); match(CloseBracket);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ElementListContext elementList() throws RecognitionException {
		...
		try {
			...
			if (_la==Comma) {
				{
				setState(376); elision();
				}
			}

			setState(379); singleExpression(0);
			setState(387);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==Comma) {
						{
						setState(381); elision();
						}
					}

					setState(384); singleExpression(0);
					}
					} 
				}
				setState(389);
	...
	public final ObjectLiteralContext objectLiteral() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(396); propertyNameAndValueList();
				}
				break;
			}
			setState(400);
		...
		try {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(406); propertyAssignment();
					}
					} 
				}
				setState(411);
	...
	public final PropertyAssignmentContext propertyAssignment() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(412); propertyName();
				setState(413); match(Colon);
				setState(414); singleExpression(0);
				}
				break;
			...
			case 2:
				...
				{
				setState(416); getter();
				setState(417); match(OpenParen);
				setState(418); match(CloseParen);
				setState(419); match(OpenBrace);
				setState(420); functionBody();
				setState(421); match(CloseBrace);
				}
				break;
			...
			case 3:
				...
				{
				setState(423); setter();
				setState(424); match(OpenParen);
				setState(425); propertySetParameterList();
				setState(426); match(CloseParen);
				setState(427); match(OpenBrace);
				setState(428); functionBody();
				setState(429); match(CloseBrace);
				}
				break;
			}
		}
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(440); match(OpenParen);
			setState(442);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << RegularExpressionLiteral) | (1L << OpenBracket) | (1L << OpenParen) | (1L << OpenBrace) | (1L << PlusPlus) | (1L << MinusMinus) | (1L << Plus) | (1L << Minus) | (1L << BitNot) | (1L << Not) | (1L << NullLiteral) | (1L << BooleanLiteral) | (1L << DecimalLiteral) | (1L << HexIntegerLiteral) | (1L << OctalIntegerLiteral) | (1L << Typeof) | (1L << New))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (Void - 67)) | (1L << (Function - 67)) | (1L << (This - 67)) | (1L << (Delete - 67)) | (1L << (Identifier - 67)) | (1L << (StringLiteral - 67)))) != 0)) {
				{
				setState(441); argumentList();
				}
			}

			setState(444); match(CloseParen);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArgumentListContext argumentList() throws RecognitionException {
		...
		try {
			...
			while (_la==Comma) {
				...
				setState(448); singleExpression(0);
				}
				}
				setState(453);
				_errHandler.sync(this);
		...
		try {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(456); singleExpression(0);
					}
					} 
				}
				setState(461);
	...
	private SingleExpressionContext singleExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case Delete:
				...
				setState(464); singleExpression(30);
				}
				break;
			case Void:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(465); match(Void);
				setState(466); singleExpression(29);
				}
				break;
			case Typeof:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(467); match(Typeof);
				setState(468); singleExpression(28);
				}
				break;
			case PlusPlus:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(469); match(PlusPlus);
				setState(470); singleExpression(27);
				}
				break;
			case MinusMinus:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(471); match(MinusMinus);
				setState(472); singleExpression(26);
				}
				break;
			case Plus:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(473); match(Plus);
				setState(474); singleExpression(25);
				}
				break;
			case Minus:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(475); match(Minus);
				setState(476); singleExpression(24);
				}
				break;
			case BitNot:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(477); match(BitNot);
				setState(478); singleExpression(23);
				}
				break;
			case Not:
				{
				...
				setState(480); singleExpression(22);
				}
				break;
			case Function:
				{
				...
				setState(485); match(OpenParen);
				setState(487);
				_la = _input.LA(1);
				if (_la==Identifier) {
					{
					setState(486); formalParameterList();
					}
				}

				setState(489); match(CloseParen);
				setState(490); match(OpenBrace);
				setState(491); functionBody();
				setState(492); match(CloseBrace);
				}
				break;
			case New:
				{
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						consume();
						setState(512); singleExpression(22);
						}
						break;
					...
					case 2:
						...
						consume();
						setState(515); singleExpression(21);
						}
						break;
					...
					case 3:
						...
						consume();
						setState(518); singleExpression(20);
						}
						break;
					...
					case 4:
						...
						consume();
						setState(521); singleExpression(19);
						}
						break;
					...
					case 5:
						...
						setState(523); match(Instanceof);
						setState(524); singleExpression(18);
						}
						break;
					...
					case 6:
						...
						setState(526); match(In);
						setState(527); singleExpression(17);
						}
						break;
					...
					case 7:
						...
						consume();
						setState(530); singleExpression(16);
						}
						break;
					...
					case 8:
						...
						setState(532); match(BitAnd);
						setState(533); singleExpression(15);
						}
						break;
					...
					case 9:
						...
						setState(535); match(BitXOr);
						setState(536); singleExpression(14);
						}
						break;
					...
					case 10:
						...
						setState(538); match(BitOr);
						setState(539); singleExpression(13);
						}
						break;
					...
					case 11:
						...
						setState(541); match(And);
						setState(542); singleExpression(12);
						}
						break;
					...
					case 12:
						...
						setState(544); match(Or);
						setState(545); singleExpression(11);
						}
						break;
					...
					case 13:
						...
						setState(547); match(QuestionMark);
						setState(548); singleExpression(0);
						setState(549); match(Colon);
						setState(550); singleExpression(10);
						}
						break;
					...
					case 14:
						...
						setState(554); singleExpression(9);
						}
						break;
					...
					case 15:
						...
						setState(556); assignmentOperator();
						setState(557); singleExpression(8);
						}
						break;
					...
					case 16:
						...
						setState(560); match(OpenBracket);
						setState(561); expressionSequence();
						setState(562); match(CloseBracket);
						}
						break;
	...
	public final ReservedWordContext reservedWord() throws RecognitionException {
		...
		try {
			...
			case Yield:
				enterOuterAlt(_localctx, 2);
				{
				setState(593); futureReservedWord();
				}
				break;
			case NullLiteral:
			case BooleanLiteral:
	...
	private boolean getter_sempred(GetterContext _localctx, int predIndex) {
		switch (predIndex) {
		case 23: return _input.LT(1).getText().equals("get");
		}
		return true;
	}
	...
	private boolean setter_sempred(SetterContext _localctx, int predIndex) {
		switch (predIndex) {
		case 24: return _input.LT(1).getText().equals("set");
		}
		return true;
	}
