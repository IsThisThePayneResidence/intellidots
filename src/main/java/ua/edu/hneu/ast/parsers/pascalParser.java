...
public class pascalParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "AND", "ARRAY", "BEGIN", "BOOLEAN", "CASE", "CHAR", "CHR", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			{
			setState(184); programHeading();
			setState(186);
			_la = _input.LA(1);
			if (_la==INTERFACE) {
				{
				setState(185); match(INTERFACE);
				}
			}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			while (((((_la - 8)) & ~0x3f) == 0 && ((1L << (_la - 8)) & ((1L << (CONST - 8)) | (1L << (FUNCTION - 8)) | (1L << (LABEL - 8)) | (1L << (PROCEDURE - 8)) | (1L << (TYPE - 8)) | (1L << (VAR - 8)) | (1L << (USES - 8)) | (1L << (IMPLEMENTATION - 8)))) != 0)) {
				...
				case LABEL:
					{
					setState(209); labelDeclarationPart();
					}
					break;
				case CONST:
					{
					setState(210); constantDefinitionPart();
					}
					break;
				case TYPE:
					{
					setState(211); typeDefinitionPart();
					}
					break;
				case VAR:
					{
					setState(212); variableDeclarationPart();
					}
					break;
				case FUNCTION:
				case PROCEDURE:
					{
					setState(213); procedureAndFunctionDeclarationPart();
					}
					break;
				case USES:
					{
					setState(214); usesUnitsPart();
					}
					break;
				case IMPLEMENTATION:
					{
					setState(215); match(IMPLEMENTATION);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			setState(221); compoundStatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConstantDefinitionPartContext constantDefinitionPart() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(241); constantDefinition();
	...
	public final ConstantChrContext constantChr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(252); match(CHR);
			setState(253); match(LPAREN);
			setState(254); unsignedInteger();
	...
	public final TypeDefinitionContext typeDefinition() throws RecognitionException {
		...
		try {
			...
			case FUNCTION:
				{
				setState(292); functionType();
				}
				break;
			case PROCEDURE:
				{
				setState(293); procedureType();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final FunctionTypeContext functionType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(296); match(FUNCTION);
			setState(298);
			_la = _input.LA(1);
			if (_la==LPAREN) {
				{
				setState(297); formalParameterList();
				}
			}

			setState(300); match(COLON);
			setState(301); resultType();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ProcedureTypeContext procedureType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(303); match(PROCEDURE);
			setState(305);
			_la = _input.LA(1);
			if (_la==LPAREN) {
				{
				setState(304); formalParameterList();
				}
			}
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case SET:
				enterOuterAlt(_localctx, 2);
				{
				setState(308); structuredType();
				}
				break;
			case POINTER:
				enterOuterAlt(_localctx, 3);
				{
				setState(309); pointerType();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final StructuredTypeContext structuredType() throws RecognitionException {
		...
		try {
			...
			case PACKED:
				enterOuterAlt(_localctx, 1);
				{
				setState(330); match(PACKED);
				setState(331); unpackedStructuredType();
				}
				break;
			case ARRAY:
			case FILE:
			...
			case SET:
				enterOuterAlt(_localctx, 2);
				{
				setState(332); unpackedStructuredType();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final UnpackedStructuredTypeContext unpackedStructuredType() throws RecognitionException {
		...
		try {
			...
			case RECORD:
				enterOuterAlt(_localctx, 2);
				{
				setState(336); recordType();
				}
				break;
			case SET:
				enterOuterAlt(_localctx, 3);
				{
				setState(337); setType();
				}
				break;
			case FILE:
				enterOuterAlt(_localctx, 4);
				{
				setState(338); fileType();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final StringtypeContext stringtype() throws RecognitionException {
		...
		try {
			...
			case NUM_INT:
				{
				setState(344); unsignedNumber();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(347); match(RBRACK);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArrayTypeContext arrayType() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(349); match(ARRAY);
				setState(350); match(LBRACK);
				setState(351); typeList();
				setState(352); match(RBRACK);
				setState(353); match(OF);
				setState(354); componentType();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(356); match(ARRAY);
				setState(357); match(LBRACK2);
				setState(358); typeList();
				setState(359); match(RBRACK2);
				setState(360); match(OF);
				setState(361); componentType();
				}
				break;
			}
		}
	...
	public final RecordTypeContext recordType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(377); match(RECORD);
			setState(378); fieldList();
	...
	public final FieldListContext fieldList() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				enterOuterAlt(_localctx, 1);
				{
				setState(381); fixedPart();
				setState(384);
				_la = _input.LA(1);
				if (_la==SEMI) {
					{
					setState(382); match(SEMI);
					setState(383); variantPart();
					}
				}
	...
	public final VariantPartContext variantPart() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(401); match(CASE);
			setState(402); tag();
			setState(403); match(OF);
			setState(404); variant();
			setState(409);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==SEMI) {
	...
	public final SetTypeContext setType() throws RecognitionException {
		...
		try {
			...
			setState(426); match(OF);
			setState(427); baseType();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PointerTypeContext pointerType() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(437); match(POINTER);
			setState(438); typeIdentifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VariableDeclarationPartContext variableDeclarationPart() throws RecognitionException {
		...
		try {
			...
			setState(441); variableDeclaration();
			setState(446);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(443); variableDeclaration();
					}
					} 
				}
				setState(448);
	...
	public final ProcedureAndFunctionDeclarationPartContext procedureAndFunctionDeclarationPart() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(455); procedureOrFunctionDeclaration();
	...
	public final ProcedureOrFunctionDeclarationContext procedureOrFunctionDeclaration() throws RecognitionException {
		...
		try {
			...
			case PROCEDURE:
				enterOuterAlt(_localctx, 1);
				{
				setState(458); procedureDeclaration();
				}
				break;
			case FUNCTION:
				enterOuterAlt(_localctx, 2);
				{
				setState(459); functionDeclaration();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ProcedureDeclarationContext procedureDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(462); match(PROCEDURE);
			setState(463); identifier();
			setState(465);
			_la = _input.LA(1);
			if (_la==LPAREN) {
				{
				setState(464); formalParameterList();
				}
			}
	...
	public final FormalParameterListContext formalParameterList() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(470); match(LPAREN);
			setState(471); formalParameterSection();
			setState(476);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==SEMI) {
				...
				setState(473); formalParameterSection();
				}
				}
				setState(478);
				_errHandler.sync(this);
	...
	public final FormalParameterSectionContext formalParameterSection() throws RecognitionException {
		...
		try {
			...
			case VAR:
				...
				setState(483); parameterGroup();
				}
				break;
			case FUNCTION:
				enterOuterAlt(_localctx, 3);
				{
				setState(484); match(FUNCTION);
				setState(485); parameterGroup();
				}
				break;
			case PROCEDURE:
				enterOuterAlt(_localctx, 4);
				{
				setState(486); match(PROCEDURE);
				setState(487); parameterGroup();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ParameterGroupContext parameterGroup() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(490); identifierList();
			setState(491); match(COLON);
			setState(492); typeIdentifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(510); match(FUNCTION);
			setState(511); identifier();
			setState(513);
			_la = _input.LA(1);
			if (_la==LPAREN) {
				{
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case NUM_INT:
				...
				setState(524); unlabelledStatement();
				}
				break;
			case BEGIN:
			case CASE:
			...
			case IDENT:
				enterOuterAlt(_localctx, 2);
				{
				setState(526); unlabelledStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final UnlabelledStatementContext unlabelledStatement() throws RecognitionException {
		...
		try {
			...
			case WITH:
				enterOuterAlt(_localctx, 2);
				{
				setState(530); structuredStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final SimpleStatementContext simpleStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(533); assignmentStatement();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(534); procedureStatement();
				}
				break;
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(612); functionDesignator();
				}
				break;
	...
	public final UnsignedConstantContext unsignedConstant() throws RecognitionException {
		...
		try {
			...
			case NUM_INT:
				enterOuterAlt(_localctx, 1);
				{
				setState(619); unsignedNumber();
				}
				break;
			case CHR:
				enterOuterAlt(_localctx, 2);
				{
				setState(620); constantChr();
				}
				break;
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 3);
	...
	public final SetContext set() throws RecognitionException {
		...
		try {
			...
			case LBRACK2:
				enterOuterAlt(_localctx, 2);
				{
				setState(642); match(LBRACK2);
				setState(643); elementList();
				setState(644); match(RBRACK2);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final StructuredStatementContext structuredStatement() throws RecognitionException {
		...
		try {
			...
			case BEGIN:
				enterOuterAlt(_localctx, 1);
				{
				setState(680); compoundStatement();
				}
				break;
			case CASE:
			case IF:
				enterOuterAlt(_localctx, 2);
				{
				setState(681); conditionalStatement();
				}
				break;
			case FOR:
			case REPEAT:
			case WHILE:
				enterOuterAlt(_localctx, 3);
				{
				setState(682); repetetiveStatement();
				}
				break;
			case WITH:
				enterOuterAlt(_localctx, 4);
				{
				setState(683); withStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final CompoundStatementContext compoundStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(686); match(BEGIN);
			setState(687); statements();
			setState(688); match(END);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			while (_la==SEMI) {
				{
				{
				setState(691); match(SEMI);
				setState(692); statement();
				}
				}
				setState(697);
				_errHandler.sync(this);
	...
	public final ConditionalStatementContext conditionalStatement() throws RecognitionException {
		...
		try {
			...
			case IF:
				enterOuterAlt(_localctx, 1);
				{
				setState(698); ifStatement();
				}
				break;
			case CASE:
				enterOuterAlt(_localctx, 2);
				{
				setState(699); caseStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final IfStatementContext ifStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(702); match(IF);
			setState(703); expression();
			setState(704); match(THEN);
			setState(705); statement();
			setState(708);
			switch ( getInterpreter().adaptivePredict(_input,58,_ctx) ) {
			case 1:
				{
				setState(706); match(ELSE);
	...
	public final CaseStatementContext caseStatement() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(710); match(CASE);
			setState(711); expression();
			setState(712); match(OF);
			setState(713); caseListElement();
			setState(718);
			_errHandler.sync(this);
			...
			if (_la==SEMI) {
				...
				setState(722); match(ELSE);
				setState(723); statements();
				}
			}
	...
	public final CaseListElementContext caseListElement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(728); constList();
			setState(729); match(COLON);
			setState(730); statement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RepetetiveStatementContext repetetiveStatement() throws RecognitionException {
		...
		try {
			...
			case WHILE:
				enterOuterAlt(_localctx, 1);
				{
				setState(732); whileStatement();
				}
				break;
			case REPEAT:
				enterOuterAlt(_localctx, 2);
				{
				setState(733); repeatStatement();
				}
				break;
			case FOR:
				enterOuterAlt(_localctx, 3);
				{
				setState(734); forStatement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final RepeatStatementContext repeatStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(742); match(REPEAT);
			setState(743); statements();
			setState(744); match(UNTIL);
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			setState(748); identifier();
			setState(749); match(ASSIGN);
			setState(750); forList();
			setState(751); match(DO);
	...
	public final WithStatementContext withStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(762); match(WITH);
			setState(763); recordVariableList();
			setState(764); match(DO);
	...
	public static final String _serializedATN =
		...
		"\13\30\30-.\4\2\r\r%%\u030a\2\u00ba\3\2\2\2\4\u00cf\3\2\2\2\6\u00d1\3"+
		"\2\2\2\b\u00dc\3\2\2\2\n\u00e1\3\2\2\2\f\u00e5\3\2\2\2\16\u00f0\3\2\2"+
		"\2\20\u00f2\3\2\2\2\22\u00fa\3\2\2\2\24\u00fe\3\2\2\2\26\u010d\3\2\2\2"+
