...
public class CSharpParser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"'elif'", "'endif'", "'line'", "ERROR", "WARNING", "REGION", "ENDREGION", 
		"PRAGMA", "'hidden'", "CONDITIONAL_SYMBOL", "DIRECTIVE_NEW_LINE", "TEXT", 
		"'}}'"
	};
	public static final int
	...
	public final Compilation_unitContext compilation_unit() throws RecognitionException {
		...
		try {
			...
			if (_la==BYTE_ORDER_MARK) {
				{
				setState(400); match(BYTE_ORDER_MARK);
				}
			}
			...
			case 1:
				{
				setState(403); extern_alias_directives();
				}
				break;
			}
			setState(407);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(409); global_attribute_section();
					}
					} 
				}
				setState(414);
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ASYNC) | (1L << CLASS) | (1L << DELEGATE) | (1L << ENUM) | (1L << EXTERN) | (1L << INTERFACE) | (1L << INTERNAL))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMESPACE - 64)) | (1L << (NEW - 64)) | (1L << (OVERRIDE - 64)) | (1L << (PARTIAL - 64)) | (1L << (PRIVATE - 64)) | (1L << (PROTECTED - 64)) | (1L << (PUBLIC - 64)) | (1L << (READONLY - 64)) | (1L << (SEALED - 64)) | (1L << (STATIC - 64)) | (1L << (STRUCT - 64)) | (1L << (UNSAFE - 64)) | (1L << (VIRTUAL - 64)) | (1L << (VOLATILE - 64)) | (1L << (OPEN_BRACKET - 64)))) != 0)) {
				{
				setState(415); namespace_member_declarations();
				}
			}

			setState(418); match(EOF);
			}
		}
	...
	public final Namespace_or_type_nameContext namespace_or_type_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					setState(421); type_argument_list();
					}
					break;
				}
				}
			...
			case 2:
				{
				setState(424); qualified_alias_member();
				}
				break;
			}
			setState(434);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						setState(429); type_argument_list();
						}
						break;
					}
					}
		...
		try {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case INTERR:
						{
						setState(438); match(INTERR);
						}
						break;
					case OPEN_BRACKET:
						{
						setState(439); rank_specifier();
						}
						break;
					case STAR:
						{
						setState(440); match(STAR);
						}
						break;
					default:
	...
	public final Simple_typeContext simple_type() throws RecognitionException {
		...
		try {
			...
			case USHORT:
				enterOuterAlt(_localctx, 1);
				{
				setState(452); numeric_type();
				}
				break;
			case BOOL:
				enterOuterAlt(_localctx, 2);
				{
				setState(453); match(BOOL);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Numeric_typeContext numeric_type() throws RecognitionException {
		...
		try {
			...
			case FLOAT:
				enterOuterAlt(_localctx, 2);
				{
				setState(457); floating_point_type();
				}
				break;
			case DECIMAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(458); match(DECIMAL);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Class_typeContext class_type() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(465); namespace_or_type_name();
				}
				break;
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(501); non_assignment_expression();
				}
				break;
			}
		}
	...
	public final Non_assignment_expressionContext non_assignment_expression() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(504); lambda_expression();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(506); conditional_expression();
				}
				break;
			}
		}
	...
	public final AssignmentContext assignment() throws RecognitionException {
		...
		try {
			...
			setState(510); assignment_operator();
	...
	public final Assignment_operatorContext assignment_operator() throws RecognitionException {
		...
		try {
			...
			case ASSIGNMENT:
				enterOuterAlt(_localctx, 1);
				{
				setState(513); match(ASSIGNMENT);
				}
				break;
			case OP_ADD_ASSIGNMENT:
				enterOuterAlt(_localctx, 2);
				{
				setState(514); match(OP_ADD_ASSIGNMENT);
				}
				break;
			case OP_SUB_ASSIGNMENT:
				enterOuterAlt(_localctx, 3);
				{
				setState(515); match(OP_SUB_ASSIGNMENT);
				}
				break;
			case OP_MULT_ASSIGNMENT:
				enterOuterAlt(_localctx, 4);
				{
				setState(516); match(OP_MULT_ASSIGNMENT);
				}
				break;
			case OP_DIV_ASSIGNMENT:
				enterOuterAlt(_localctx, 5);
				{
				setState(517); match(OP_DIV_ASSIGNMENT);
				}
				break;
			case OP_MOD_ASSIGNMENT:
				enterOuterAlt(_localctx, 6);
				{
				setState(518); match(OP_MOD_ASSIGNMENT);
				}
				break;
			case OP_AND_ASSIGNMENT:
				enterOuterAlt(_localctx, 7);
				{
				setState(519); match(OP_AND_ASSIGNMENT);
				}
				break;
			case OP_OR_ASSIGNMENT:
				enterOuterAlt(_localctx, 8);
				{
				setState(520); match(OP_OR_ASSIGNMENT);
				}
				break;
			case OP_XOR_ASSIGNMENT:
				enterOuterAlt(_localctx, 9);
				{
				setState(521); match(OP_XOR_ASSIGNMENT);
				}
				break;
			case OP_LEFT_SHIFT_ASSIGNMENT:
				enterOuterAlt(_localctx, 10);
				{
				setState(522); match(OP_LEFT_SHIFT_ASSIGNMENT);
				}
				break;
			case GT:
				enterOuterAlt(_localctx, 11);
				{
				setState(523); right_shift_assignment();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Conditional_expressionContext conditional_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(526); null_coalescing_expression();
			setState(532);
			_la = _input.LA(1);
			if (_la==INTERR) {
				{
				setState(527); match(INTERR);
	...
	public final Null_coalescing_expressionContext null_coalescing_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(534); conditional_or_expression();
			setState(537);
			_la = _input.LA(1);
			if (_la==OP_COALESCING) {
				{
				setState(535); match(OP_COALESCING);
				setState(536); null_coalescing_expression();
				}
			}
	...
	public final Conditional_or_expressionContext conditional_or_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(539); conditional_and_expression();
			setState(544);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==OP_OR) {
				{
				{
				setState(540); match(OP_OR);
				setState(541); conditional_and_expression();
				}
				}
				setState(546);
				_errHandler.sync(this);
	...
	public final Conditional_and_expressionContext conditional_and_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(547); inclusive_or_expression();
			setState(552);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==OP_AND) {
				{
				{
				setState(548); match(OP_AND);
				setState(549); inclusive_or_expression();
				}
				}
				setState(554);
				_errHandler.sync(this);
	...
	public final Inclusive_or_expressionContext inclusive_or_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(555); exclusive_or_expression();
			setState(560);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==BITWISE_OR) {
				{
				{
				setState(556); match(BITWISE_OR);
				setState(557); exclusive_or_expression();
				}
				}
				setState(562);
				_errHandler.sync(this);
	...
	public final Exclusive_or_expressionContext exclusive_or_expression() throws RecognitionException {
		...
		try {
			...
			while (_la==CARET) {
				{
				{
				setState(564); match(CARET);
				setState(565); and_expression();
				}
				}
				setState(570);
				_errHandler.sync(this);
	...
	public final And_expressionContext and_expression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(571); equality_expression();
			setState(576);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(572); match(AMP);
					setState(573); equality_expression();
					}
					} 
				}
				setState(578);
	...
	public final Equality_expressionContext equality_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(579); relational_expression();
			setState(584);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==OP_EQ || _la==OP_NE) {
				...
				consume();
				setState(581); relational_expression();
				}
				}
				setState(586);
				_errHandler.sync(this);
		...
		try {
			...
			while (_la==AS || _la==IS || ((((_la - 142)) & ~0x3f) == 0 && ((1L << (_la - 142)) & ((1L << (LT - 142)) | (1L << (GT - 142)) | (1L << (OP_LE - 142)) | (1L << (OP_GE - 142)))) != 0)) {
				...
				case OP_GE:
					...
					consume();
					setState(589); shift_expression();
					}
					break;
				case IS:
					{
					setState(590); match(IS);
					setState(591); isType();
					}
					break;
				case AS:
	...
	public final Shift_expressionContext shift_expression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(599); additive_expression();
			setState(607);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case OP_LEFT_SHIFT:
						{
						setState(600); match(OP_LEFT_SHIFT);
						}
						break;
					case GT:
						{
						setState(601); right_shift();
						}
						break;
					default:
						throw new NoViableAltException(this);
					}
					setState(604); additive_expression();
					}
					} 
				}
				setState(609);
		...
		try {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					consume();
					setState(612); multiplicative_expression();
					}
					} 
				}
				setState(617);
	...
	public final Unary_expressionContext unary_expression() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(626); primary_expression();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(627); match(PLUS);
				setState(628); unary_expression();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(629); match(MINUS);
				setState(630); unary_expression();
				}
				break;
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(631); match(BANG);
				setState(632); unary_expression();
				}
				break;
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(633); match(TILDE);
				setState(634); unary_expression();
				}
				break;
			...
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(639); match(OPEN_PARENS);
				setState(640); type();
				setState(641); match(CLOSE_PARENS);
			...
			case 9:
				enterOuterAlt(_localctx, 9);
				{
				setState(644); match(AWAIT);
				setState(645); unary_expression();
				}
				break;
			...
			case 10:
				enterOuterAlt(_localctx, 10);
				{
				setState(646); match(AMP);
				setState(647); unary_expression();
				}
				break;
			...
			case 11:
				enterOuterAlt(_localctx, 11);
				{
				setState(648); match(STAR);
				setState(649); unary_expression();
				}
				break;
			}
		}
	...
	public final Primary_expressionContext primary_expression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(652); ((Primary_expressionContext)_localctx).pe = primary_expression_start();
			setState(656);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(653); bracket_expression();
					}
					} 
				}
				setState(658);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case INTERR:
						{
						setState(659); member_access();
						}
						break;
					case OPEN_PARENS:
						{
						setState(660); method_invocation();
						}
						break;
					case OP_INC:
						{
						setState(661); match(OP_INC);
						}
						break;
					case OP_DEC:
						{
						setState(662); match(OP_DEC);
						}
						break;
					case OP_PTR:
						{
						setState(663); match(OP_PTR);
					...
					while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
						if ( _alt==1 ) {
							{
							{
							setState(667); bracket_expression();
							}
							} 
						}
						setState(672);
	...
	public final Primary_expression_startContext primary_expression_start() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				case 1:
					{
					setState(680); type_argument_list();
					}
					break;
				}
				}
			...
			case 3:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(683); match(OPEN_PARENS);
				setState(684); expression();
				setState(685); match(CLOSE_PARENS);
				}
				break;
			...
			case 5:
				...
				enterOuterAlt(_localctx, 5);
				{
				setState(688); qualified_alias_member();
				}
				break;
			...
			case 6:
				...
				enterOuterAlt(_localctx, 6);
				{
				setState(689); match(LITERAL_ACCESS);
				}
				break;
			...
			case 8:
				...
				case DOT:
					...
					case 1:
						{
						setState(694); type_argument_list();
						}
						break;
					}
					}
				...
				case OPEN_BRACKET:
					{
					setState(697); match(OPEN_BRACKET);
					setState(698); expression_list();
					setState(699); match(CLOSE_BRACKET);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case 9:
				...
				case IDENTIFIER:
					...
					case 1:
						{
						setState(705); object_creation_expression();
						}
						break;

					case 2:
						{
						setState(706); object_or_collection_initializer();
						}
						break;

					case 3:
						{
						setState(707); match(OPEN_BRACKET);
						setState(708); expression_list();
						setState(709); match(CLOSE_BRACKET);
						setState(713);
						_errHandler.sync(this);
						...
						if (_la==OPEN_BRACE) {
							{
							setState(716); array_initializer();
							}
						}
					...
					case 4:
						...
						setState(724); array_initializer();
						}
						break;
					}
					}
				...
				case OPEN_BRACE:
					{
					setState(728); anonymous_object_initializer();
					}
					break;
				case OPEN_BRACKET:
					{
					setState(729); rank_specifier();
					setState(730); array_initializer();
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case 10:
				...
				enterOuterAlt(_localctx, 10);
				{
				setState(734); match(TYPEOF);
				setState(735); match(OPEN_PARENS);
				setState(739);
				switch ( getInterpreter().adaptivePredict(_input,49,_ctx) ) {
				case 1:
					{
					setState(736); unbound_type_name();
					}
					break;
				...
				case 3:
					{
					setState(738); match(VOID);
					}
					break;
				}
				setState(741); match(CLOSE_PARENS);
				}
				break;
			...
			case 11:
				...
				enterOuterAlt(_localctx, 11);
				{
				setState(742); match(CHECKED);
				setState(743); match(OPEN_PARENS);
				setState(744); expression();
				setState(745); match(CLOSE_PARENS);
				}
				break;
			...
			case 12:
				...
				{
				setState(747); match(UNCHECKED);
				setState(748); match(OPEN_PARENS);
				setState(749); expression();
				setState(750); match(CLOSE_PARENS);
				}
				break;
			...
			case 13:
				...
				{
				setState(752); match(DEFAULT);
				setState(753); match(OPEN_PARENS);
				setState(754); type();
				setState(755); match(CLOSE_PARENS);
				}
				break;
			...
			case 14:
				...
				if (_la==ASYNC) {
					{
					setState(757); match(ASYNC);
					}
				}

				setState(760); match(DELEGATE);
				setState(766);
				_la = _input.LA(1);
				if (_la==OPEN_PARENS) {
					{
					...
					if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << DECIMAL) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (OBJECT - 67)) | (1L << (ON - 67)) | (1L << (ORDERBY - 67)) | (1L << (OUT - 67)) | (1L << (PARTIAL - 67)) | (1L << (REF - 67)) | (1L << (REMOVE - 67)) | (1L << (SBYTE - 67)) | (1L << (SELECT - 67)) | (1L << (SET - 67)) | (1L << (SHORT - 67)) | (1L << (STRING - 67)) | (1L << (UINT - 67)) | (1L << (ULONG - 67)) | (1L << (USHORT - 67)) | (1L << (VOID - 67)) | (1L << (WHEN - 67)) | (1L << (WHERE - 67)) | (1L << (YIELD - 67)) | (1L << (IDENTIFIER - 67)))) != 0)) {
						{
						setState(762); explicit_anonymous_function_parameter_list();
						}
					}

					setState(765); match(CLOSE_PARENS);
					}
				}
			...
			case 15:
				...
				{
				setState(769); match(SIZEOF);
				setState(770); match(OPEN_PARENS);
				setState(771); type();
				setState(772); match(CLOSE_PARENS);
				}
				break;
			...
			case 16:
				...
				{
				setState(774); match(NAMEOF);
				setState(775); match(OPEN_PARENS);
				setState(781);
				_errHandler.sync(this);
				...
				setState(785); match(CLOSE_PARENS);
				}
				break;
			}
		}
	...
	public final Member_accessContext member_access() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(794); type_argument_list();
				}
				break;
			}
			}
	...
	public final Bracket_expressionContext bracket_expression() throws RecognitionException {
		...
		try {
			...
			if (_la==INTERR) {
				{
				setState(797); match(INTERR);
				}
			}

			setState(800); match(OPEN_BRACKET);
			setState(801); indexer_argument();
			setState(806);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
			...
			setState(809); match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Object_or_collection_initializerContext object_or_collection_initializer() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(828); object_initializer();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(829); collection_initializer();
				}
				break;
			}
		}
	...
	public final Object_initializerContext object_initializer() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BY) | (1L << DESCENDING) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << NAMEOF))) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & ((1L << (ON - 68)) | (1L << (ORDERBY - 68)) | (1L << (PARTIAL - 68)) | (1L << (REMOVE - 68)) | (1L << (SELECT - 68)) | (1L << (SET - 68)) | (1L << (WHEN - 68)) | (1L << (WHERE - 68)) | (1L << (YIELD - 68)) | (1L << (IDENTIFIER - 68)) | (1L << (OPEN_BRACKET - 68)))) != 0)) {
				{
				setState(833); member_initializer_list();
				setState(835);
				_la = _input.LA(1);
				if (_la==COMMA) {
					{
			...
			setState(839); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Member_initializer_listContext member_initializer_list() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(841); member_initializer();
			setState(846);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(843); member_initializer();
					}
					} 
				}
				setState(848);
	...
	public final Member_initializerContext member_initializer() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACKET:
				{
				setState(850); match(OPEN_BRACKET);
				setState(851); expression();
				setState(852); match(CLOSE_BRACKET);
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(856); match(ASSIGNMENT);
			setState(857); initializer_value();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Initializer_valueContext initializer_value() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACE:
				enterOuterAlt(_localctx, 2);
				{
				setState(860); object_or_collection_initializer();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Collection_initializerContext collection_initializer() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(863); match(OPEN_BRACE);
			setState(864); element_initializer();
			setState(869);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(866); element_initializer();
					}
					} 
				}
				setState(871);
			...
			setState(875); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Element_initializerContext element_initializer() throws RecognitionException {
		...
		try {
			...
			case OP_DEC:
				enterOuterAlt(_localctx, 1);
				{
				setState(877); non_assignment_expression();
				}
				break;
			case OPEN_BRACE:
				enterOuterAlt(_localctx, 2);
				{
				setState(878); match(OPEN_BRACE);
				setState(879); expression_list();
	...
	public final Anonymous_object_initializerContext anonymous_object_initializer() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0)) {
				{
				setState(885); member_declarator_list();
				setState(887);
				_la = _input.LA(1);
				if (_la==COMMA) {
					{
			...
			setState(891); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Member_declarator_listContext member_declarator_list() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(893); member_declarator();
			setState(898);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(895); member_declarator();
					}
					} 
				}
				setState(900);
	...
	public final Member_declaratorContext member_declarator() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(901); primary_expression();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(902); identifier();
				setState(903); match(ASSIGNMENT);
	...
	public final Unbound_type_nameContext unbound_type_name() throws RecognitionException {
		...
		try {
			...
			case LT:
				...
				if (_la==LT) {
					{
					setState(909); generic_dimension_specifier();
					}
				}
			...
			case DOUBLE_COLON:
				{
				setState(912); match(DOUBLE_COLON);
				setState(913); identifier();
				setState(915);
				_la = _input.LA(1);
				if (_la==LT) {
					{
					setState(914); generic_dimension_specifier();
					}
				}
			...
			while (_la==DOT) {
				...
				if (_la==LT) {
					{
					setState(921); generic_dimension_specifier();
					}
				}
		...
		try {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case OPEN_BRACKET:
						{
						setState(939); rank_specifier();
						}
						break;
					case STAR:
						{
						setState(940); match(STAR);
						}
						break;
					default:
						throw new NoViableAltException(this);
	...
	public final Lambda_expressionContext lambda_expression() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(949); match(ASYNC);
				}
				break;
			}
			setState(952); anonymous_function_signature();
			setState(953); right_arrow();
			setState(954); anonymous_function_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Anonymous_function_signatureContext anonymous_function_signature() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(956); match(OPEN_PARENS);
				setState(957); match(CLOSE_PARENS);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(958); match(OPEN_PARENS);
				setState(959); explicit_anonymous_function_parameter_list();
				setState(960); match(CLOSE_PARENS);
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(962); match(OPEN_PARENS);
				setState(963); implicit_anonymous_function_parameter_list();
				setState(964); match(CLOSE_PARENS);
				}
				break;
	...
	public final Explicit_anonymous_function_parameter_listContext explicit_anonymous_function_parameter_list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(969); explicit_anonymous_function_parameter();
			setState(974);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(971); explicit_anonymous_function_parameter();
				}
				}
				setState(976);
				_errHandler.sync(this);
	...
	public final Query_expressionContext query_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(995); from_clause();
			setState(996); query_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final From_clauseContext from_clause() throws RecognitionException {
		...
		try {
			...
			setState(1002); identifier();
			setState(1003); match(IN);
			setState(1004); expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Query_bodyContext query_body() throws RecognitionException {
		...
		try {
			...
			while (((((_la - 47)) & ~0x3f) == 0 && ((1L << (_la - 47)) & ((1L << (FROM - 47)) | (1L << (JOIN - 47)) | (1L << (LET - 47)) | (1L << (ORDERBY - 47)) | (1L << (WHERE - 47)))) != 0)) {
				{
				{
				setState(1006); query_body_clause();
				}
				}
				setState(1011);
				_errHandler.sync(this);
			...
			setState(1012); select_or_group_clause();
			setState(1014);
			switch ( getInterpreter().adaptivePredict(_input,91,_ctx) ) {
			case 1:
				{
				setState(1013); query_continuation();
				}
				break;
			}
			}
	...
	public final Query_body_clauseContext query_body_clause() throws RecognitionException {
		...
		try {
			...
			case FROM:
				enterOuterAlt(_localctx, 1);
				{
				setState(1016); from_clause();
				}
				break;
			case LET:
				enterOuterAlt(_localctx, 2);
				{
				setState(1017); let_clause();
				}
				break;
			case WHERE:
				enterOuterAlt(_localctx, 3);
				{
				setState(1018); where_clause();
				}
				break;
			case JOIN:
				enterOuterAlt(_localctx, 4);
				{
				setState(1019); combined_join_clause();
				}
				break;
			case ORDERBY:
				enterOuterAlt(_localctx, 5);
				{
				setState(1020); orderby_clause();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Let_clauseContext let_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1023); match(LET);
			setState(1024); identifier();
	...
	public final Combined_join_clauseContext combined_join_clause() throws RecognitionException {
		...
		try {
			...
			setState(1035); identifier();
			setState(1036); match(IN);
			setState(1037); expression();
			setState(1038); match(ON);
			setState(1039); expression();
			setState(1040); match(EQUALS);
			setState(1041); expression();
			setState(1044);
			_la = _input.LA(1);
			if (_la==INTO) {
				{
				setState(1042); match(INTO);
	...
	public final Orderby_clauseContext orderby_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1046); match(ORDERBY);
			setState(1047); ordering();
			setState(1052);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Select_or_group_clauseContext select_or_group_clause() throws RecognitionException {
		...
		try {
			...
			case GROUP:
				enterOuterAlt(_localctx, 2);
				{
				setState(1061); match(GROUP);
				setState(1062); expression();
				setState(1063); match(BY);
				setState(1064); expression();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Query_continuationContext query_continuation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1068); match(INTO);
			setState(1069); identifier();
			setState(1070); query_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				case IDENTIFIER:
					{
					setState(1076); local_variable_declaration();
					}
					break;
				case CONST:
					{
					setState(1077); local_constant_declaration();
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(1080); match(SEMICOLON);
				}
				break;
			...
			case 3:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(1082); embedded_statement();
				}
				break;
			}
		}
	...
	public final Embedded_statementContext embedded_statement() throws RecognitionException {
		...
		try {
			...
			case OP_DEC:
				enterOuterAlt(_localctx, 2);
				{
				setState(1086); simple_embedded_statement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Simple_embedded_statementContext simple_embedded_statement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(1093); match(IF);
				setState(1094); match(OPEN_PARENS);
				setState(1095); expression();
				setState(1096); match(CLOSE_PARENS);
				setState(1097); if_body();
				setState(1100);
				switch ( getInterpreter().adaptivePredict(_input,101,_ctx) ) {
				case 1:
					{
					setState(1098); match(ELSE);
					setState(1099); if_body();
					}
					break;
				}
				}
			...
			case 4:
				...
				setState(1103); match(OPEN_PARENS);
				setState(1104); expression();
				setState(1105); match(CLOSE_PARENS);
				setState(1106); match(OPEN_BRACE);
				setState(1110);
				_errHandler.sync(this);
				_la = _input.LA(1);
				...
				setState(1113); match(CLOSE_BRACE);
				}
				break;
			...
			case 5:
				...
				enterOuterAlt(_localctx, 5);
				{
				setState(1115); match(WHILE);
				setState(1116); match(OPEN_PARENS);
				setState(1117); expression();
				setState(1118); match(CLOSE_PARENS);
				setState(1119); embedded_statement();
				}
				break;
			...
			case 6:
				...
				enterOuterAlt(_localctx, 6);
				{
				setState(1121); match(DO);
				setState(1122); embedded_statement();
				setState(1123); match(WHILE);
				setState(1124); match(OPEN_PARENS);
				setState(1125); expression();
				setState(1126); match(CLOSE_PARENS);
			...
			case 7:
				...
				enterOuterAlt(_localctx, 7);
				{
				setState(1129); match(FOR);
				setState(1130); match(OPEN_PARENS);
				setState(1132);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (VOID - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
					{
					setState(1131); for_initializer();
					}
				}

				setState(1134); match(SEMICOLON);
				setState(1136);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
					{
				...
				setState(1138); match(SEMICOLON);
				setState(1140);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
					{
					setState(1139); for_iterator();
					}
				}

				setState(1142); match(CLOSE_PARENS);
				setState(1143); embedded_statement();
				}
				break;
			...
			case 8:
				...
				enterOuterAlt(_localctx, 8);
				{
				setState(1144); match(FOREACH);
				setState(1145); match(OPEN_PARENS);
				setState(1146); type();
				setState(1147); identifier();
				setState(1148); match(IN);
				setState(1149); expression();
				setState(1150); match(CLOSE_PARENS);
				setState(1151); embedded_statement();
				}
				break;
			...
			case 9:
				...
				enterOuterAlt(_localctx, 9);
				{
				setState(1153); match(BREAK);
				setState(1154); match(SEMICOLON);
				}
				break;
			...
			case 11:
				...
				case DEFAULT:
					{
					setState(1161); match(DEFAULT);
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(1164); match(SEMICOLON);
				}
				break;
			...
			case 13:
				...
				enterOuterAlt(_localctx, 13);
				{
				setState(1170); match(THROW);
				setState(1172);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
					{
					setState(1171); expression();
					}
				}

				setState(1174); match(SEMICOLON);
				}
				break;
			...
			case 14:
				...
				enterOuterAlt(_localctx, 14);
				{
				setState(1175); match(TRY);
				setState(1176); block();
				setState(1182);
				switch (_input.LA(1)) {
				case CATCH:
					{
					setState(1177); catch_clauses();
					setState(1179);
					_la = _input.LA(1);
					if (_la==FINALLY) {
						{
						setState(1178); finally_clause();
						}
					}
			...
			case 17:
				...
				{
				setState(1188); match(LOCK);
				setState(1189); match(OPEN_PARENS);
				setState(1190); expression();
				setState(1191); match(CLOSE_PARENS);
				setState(1192); embedded_statement();
				}
				break;
			...
			case 18:
				...
				{
				setState(1194); match(USING);
				setState(1195); match(OPEN_PARENS);
				setState(1196); resource_acquisition();
				setState(1197); match(CLOSE_PARENS);
				setState(1198); embedded_statement();
				}
				break;
			...
			case 19:
				...
				{
				setState(1200); match(YIELD);
				setState(1204);
				switch (_input.LA(1)) {
				case RETURN:
					{
					setState(1201); match(RETURN);
					setState(1202); expression();
					}
					break;
				case BREAK:
					{
			...
			case 21:
				...
				{
				setState(1209); match(FIXED);
				setState(1210); match(OPEN_PARENS);
				setState(1211); pointer_type();
				setState(1212); fixed_pointer_declarators();
				setState(1213); match(CLOSE_PARENS);
				setState(1214); embedded_statement();
				}
				break;
			}
		}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BREAK) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << CONST) | (1L << CONTINUE) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DO) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FIXED) | (1L << FLOAT) | (1L << FOR) | (1L << FOREACH) | (1L << FROM) | (1L << GET) | (1L << GOTO) | (1L << GROUP) | (1L << IF) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LOCK) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (RETURN - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (SWITCH - 65)) | (1L << (THIS - 65)) | (1L << (THROW - 65)) | (1L << (TRUE - 65)) | (1L << (TRY - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (UNSAFE - 65)) | (1L << (USHORT - 65)) | (1L << (USING - 65)) | (1L << (VOID - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (WHILE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_BRACE - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 130)) & ~0x3f) == 0 && ((1L << (_la - 130)) & ((1L << (SEMICOLON - 130)) | (1L << (PLUS - 130)) | (1L << (MINUS - 130)) | (1L << (STAR - 130)) | (1L << (AMP - 130)) | (1L << (BANG - 130)) | (1L << (TILDE - 130)) | (1L << (OP_INC - 130)) | (1L << (OP_DEC - 130)))) != 0)) {
				{
				setState(1219); statement_list();
				}
			}

			setState(1222); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Local_variable_declarationContext local_variable_declaration() throws RecognitionException {
		...
		try {
			...
			{
			setState(1224); type();
			setState(1225); local_variable_declarator();
			setState(1230);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1227); local_variable_declarator();
				}
				}
				setState(1232);
				_errHandler.sync(this);
	...
	public final Local_variable_declaratorContext local_variable_declarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1233); identifier();
			setState(1236);
			_la = _input.LA(1);
			if (_la==ASSIGNMENT) {
				{
				setState(1234); match(ASSIGNMENT);
				setState(1235); local_variable_initializer();
				}
			}
	...
	public final Local_variable_initializerContext local_variable_initializer() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACE:
				enterOuterAlt(_localctx, 2);
				{
				setState(1239); array_initializer();
				}
				break;
			case STACKALLOC:
				enterOuterAlt(_localctx, 3);
				{
				setState(1240); local_variable_initializer_unsafe();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Local_constant_declarationContext local_constant_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1243); match(CONST);
			setState(1244); type();
			setState(1245); constant_declarators();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final If_bodyContext if_body() throws RecognitionException {
		...
		try {
			...
			case OP_DEC:
				enterOuterAlt(_localctx, 2);
				{
				setState(1248); simple_embedded_statement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Switch_labelContext switch_label() throws RecognitionException {
		...
		try {
			...
			case CASE:
				...
				setState(1259); expression();
				setState(1260); match(COLON);
				}
				break;
			case DEFAULT:
				enterOuterAlt(_localctx, 2);
	...
	public final For_initializerContext for_initializer() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1271); local_variable_declaration();
				}
				break;
	...
	public final Catch_clausesContext catch_clauses() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1290); specific_catch_clause();
				setState(1294);
				_errHandler.sync(this);
				...
				while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						{
						{
						setState(1291); specific_catch_clause();
						}
						} 
					}
					setState(1296);
				...
				if (_la==CATCH) {
					{
					setState(1297); general_catch_clause();
					}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1300); general_catch_clause();
				}
				break;
			}
		}
	...
	public final Specific_catch_clauseContext specific_catch_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1303); match(CATCH);
			setState(1304); match(OPEN_PARENS);
			setState(1305); class_type();
			setState(1307);
			_la = _input.LA(1);
			...
			setState(1309); match(CLOSE_PARENS);
			setState(1311);
			_la = _input.LA(1);
			if (_la==WHEN) {
				{
				setState(1310); exception_filter();
				}
			}
	...
	public final General_catch_clauseContext general_catch_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1315); match(CATCH);
			setState(1317);
			_la = _input.LA(1);
			if (_la==WHEN) {
				{
				setState(1316); exception_filter();
				}
			}
	...
	public final Exception_filterContext exception_filter() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1321); match(WHEN);
			setState(1322); match(OPEN_PARENS);
			setState(1323); expression();
			setState(1324); match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Resource_acquisitionContext resource_acquisition() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1329); local_variable_declaration();
				}
				break;
	...
	public final Namespace_declarationContext namespace_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1333); match(NAMESPACE);
			setState(1334); ((Namespace_declarationContext)_localctx).qi = qualified_identifier();
			setState(1335); namespace_body();
			setState(1337);
			_la = _input.LA(1);
			if (_la==SEMICOLON) {
				{
				setState(1336); match(SEMICOLON);
				}
			}
	...
	public final Qualified_identifierContext qualified_identifier() throws RecognitionException {
		...
		try {
			...
			while (_la==DOT) {
				{
				{
				setState(1340); match(DOT);
				setState(1341); identifier();
				}
				}
				setState(1346);
				_errHandler.sync(this);
	...
	public final Namespace_bodyContext namespace_body() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1347); match(OPEN_BRACE);
			setState(1349);
			switch ( getInterpreter().adaptivePredict(_input,133,_ctx) ) {
			case 1:
				{
				setState(1348); extern_alias_directives();
				}
				break;
			}
			setState(1352);
			...
			if (_la==USING) {
				{
				setState(1351); using_directives();
				}
			}
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ASYNC) | (1L << CLASS) | (1L << DELEGATE) | (1L << ENUM) | (1L << EXTERN) | (1L << INTERFACE) | (1L << INTERNAL))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMESPACE - 64)) | (1L << (NEW - 64)) | (1L << (OVERRIDE - 64)) | (1L << (PARTIAL - 64)) | (1L << (PRIVATE - 64)) | (1L << (PROTECTED - 64)) | (1L << (PUBLIC - 64)) | (1L << (READONLY - 64)) | (1L << (SEALED - 64)) | (1L << (STATIC - 64)) | (1L << (STRUCT - 64)) | (1L << (UNSAFE - 64)) | (1L << (VIRTUAL - 64)) | (1L << (VOLATILE - 64)) | (1L << (OPEN_BRACKET - 64)))) != 0)) {
				{
				setState(1354); namespace_member_declarations();
				}
			}
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(1359); extern_alias_directive();
					}
					}
					break;
				default:
	...
	public final Extern_alias_directiveContext extern_alias_directive() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1364); match(EXTERN);
			setState(1365); match(ALIAS);
			setState(1366); identifier();
			setState(1367); match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Using_directiveContext using_directive() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(1374); match(USING);
				setState(1375); identifier();
				setState(1376); match(ASSIGNMENT);
				setState(1377); namespace_or_type_name();
				setState(1378); match(SEMICOLON);
				}
				break;
			...
			case 2:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(1380); match(USING);
				setState(1381); namespace_or_type_name();
				setState(1382); match(SEMICOLON);
				}
				break;
			...
			case 3:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(1384); match(USING);
				setState(1385); match(STATIC);
				setState(1386); namespace_or_type_name();
	...
	public final Namespace_member_declarationsContext namespace_member_declarations() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(1391); namespace_member_declaration();
				}
				}
				setState(1394); 
				_errHandler.sync(this);
	...
	public final Namespace_member_declarationContext namespace_member_declaration() throws RecognitionException {
		...
		try {
			...
			case NAMESPACE:
				enterOuterAlt(_localctx, 1);
				{
				setState(1396); namespace_declaration();
				}
				break;
			case ABSTRACT:
			case ASYNC:
			...
			case OPEN_BRACKET:
				enterOuterAlt(_localctx, 2);
				{
				setState(1397); type_declaration();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Type_declarationContext type_declaration() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ASYNC) | (1L << EXTERN) | (1L << INTERNAL))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (OVERRIDE - 65)) | (1L << (PARTIAL - 65)) | (1L << (PRIVATE - 65)) | (1L << (PROTECTED - 65)) | (1L << (PUBLIC - 65)) | (1L << (READONLY - 65)) | (1L << (SEALED - 65)) | (1L << (STATIC - 65)) | (1L << (UNSAFE - 65)) | (1L << (VIRTUAL - 65)) | (1L << (VOLATILE - 65)))) != 0)) {
				{
				setState(1403); all_member_modifiers();
				}
			}
			...
			case CLASS:
				{
				setState(1406); class_definition();
				}
				break;
			case STRUCT:
				{
				setState(1407); struct_definition();
				}
				break;
			case INTERFACE:
				{
				setState(1408); interface_definition();
				}
				break;
			case ENUM:
				{
				setState(1409); enum_definition();
				}
				break;
			case DELEGATE:
				{
				setState(1410); delegate_definition();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Qualified_alias_memberContext qualified_alias_member() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1413); identifier();
			setState(1414); match(DOUBLE_COLON);
			setState(1415); identifier();
			setState(1417);
			switch ( getInterpreter().adaptivePredict(_input,144,_ctx) ) {
			case 1:
				{
				setState(1416); type_argument_list();
				}
				break;
			}
			}
	...
	public final Type_parameterContext type_parameter() throws RecognitionException {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				setState(1430); attributes();
				}
			}

			setState(1433); identifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Class_baseContext class_base() throws RecognitionException {
		...
		try {
			...
			while (_la==COMMA) {
				...
				setState(1438); namespace_or_type_name();
				}
				}
				setState(1443);
				_errHandler.sync(this);
	...
	public final Interface_type_listContext interface_type_list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1444); namespace_or_type_name();
			setState(1449);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1446); namespace_or_type_name();
				}
				}
				setState(1451);
				_errHandler.sync(this);
	...
	public final Type_parameter_constraints_clausesContext type_parameter_constraints_clauses() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(1452); type_parameter_constraints_clause();
				}
				}
				setState(1455); 
				_errHandler.sync(this);
	...
	public final Type_parameter_constraints_clauseContext type_parameter_constraints_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1457); match(WHERE);
			setState(1458); identifier();
			setState(1459); match(COLON);
			setState(1460); type_parameter_constraints();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Type_parameter_constraintsContext type_parameter_constraints() throws RecognitionException {
		...
		try {
			...
			case NEW:
				enterOuterAlt(_localctx, 1);
				{
				setState(1462); constructor_constraint();
				}
				break;
			case ADD:
			case ALIAS:
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 2);
				{
				setState(1463); primary_constraint();
				setState(1466);
				switch ( getInterpreter().adaptivePredict(_input,150,_ctx) ) {
				case 1:
					{
					setState(1464); match(COMMA);
					setState(1465); secondary_constraints();
					}
					break;
				}
				setState(1470);
				...
				if (_la==COMMA) {
					...
					setState(1469); constructor_constraint();
					}
				}
	...
	public final Secondary_constraintsContext secondary_constraints() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(1479); namespace_or_type_name();
			setState(1484);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(1481); namespace_or_type_name();
					}
					} 
				}
				setState(1486);
	...
	public final Constructor_constraintContext constructor_constraint() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1487); match(NEW);
			setState(1488); match(OPEN_PARENS);
			setState(1489); match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Class_bodyContext class_body() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1491); match(OPEN_BRACE);
			setState(1493);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CLASS) | (1L << CONST) | (1L << DECIMAL) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << ENUM) | (1L << EQUALS) | (1L << EVENT) | (1L << EXPLICIT) | (1L << EXTERN) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << IMPLICIT) | (1L << INT) | (1L << INTERFACE) | (1L << INTERNAL) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (OVERRIDE - 65)) | (1L << (PARTIAL - 65)) | (1L << (PRIVATE - 65)) | (1L << (PROTECTED - 65)) | (1L << (PUBLIC - 65)) | (1L << (READONLY - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SEALED - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (STATIC - 65)) | (1L << (STRING - 65)) | (1L << (STRUCT - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNSAFE - 65)) | (1L << (USHORT - 65)) | (1L << (VIRTUAL - 65)) | (1L << (VOID - 65)) | (1L << (VOLATILE - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (OPEN_BRACKET - 65)))) != 0) || _la==TILDE) {
				{
				setState(1492); class_member_declarations();
				}
			}
	...
	public final Class_member_declarationsContext class_member_declarations() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(1497); class_member_declaration();
				}
				}
				setState(1500); 
				_errHandler.sync(this);
	...
	public final Class_member_declarationContext class_member_declaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1505); all_member_modifiers();
				}
				break;
			}
			setState(1510);
			...
			case IDENTIFIER:
				{
				setState(1508); common_member_declaration();
				}
				break;
			case TILDE:
				{
				setState(1509); destructor_definition();
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(1512); all_member_modifier();
					}
					}
					break;
				default:
	...
	public final Common_member_declarationContext common_member_declaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1519); constant_declaration();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1520); typed_member_declaration();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1521); event_declaration();
				}
				break;
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(1522); conversion_operator_declarator();
				setState(1528);
				switch (_input.LA(1)) {
				case OPEN_BRACE:
				case SEMICOLON:
				...
				case ASSIGNMENT:
					{
					setState(1524); right_arrow();
					setState(1525); expression();
					setState(1526); match(SEMICOLON);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(1530); constructor_declaration();
				}
				break;
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(1531); match(VOID);
				setState(1532); method_declaration();
				}
				break;
			...
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(1533); class_definition();
				}
				break;
			...
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(1534); struct_definition();
				}
				break;
			...
			case 9:
				enterOuterAlt(_localctx, 9);
				{
				setState(1535); interface_definition();
				}
				break;
			...
			case 11:
				enterOuterAlt(_localctx, 11);
				{
				setState(1537); delegate_definition();
				}
				break;
			}
		}
	...
	public final Typed_member_declarationContext typed_member_declaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1541); namespace_or_type_name();
				setState(1542); match(DOT);
				setState(1543); indexer_declaration();
				}
				break;

			case 2:
				{
				setState(1545); method_declaration();
				}
				break;

			case 3:
				{
				setState(1546); property_declaration();
				}
				break;

			case 4:
				{
				setState(1547); indexer_declaration();
				}
				break;

			case 5:
				{
				setState(1548); operator_declaration();
				}
				break;

			case 6:
				{
				setState(1549); field_declaration();
				}
				break;
			}
			}
	...
	public final Constant_declaratorsContext constant_declarators() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1552); constant_declarator();
			setState(1557);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1554); constant_declarator();
				}
				}
				setState(1559);
				_errHandler.sync(this);
	...
	public final Constant_declaratorContext constant_declarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1560); identifier();
			setState(1561); match(ASSIGNMENT);
	...
	public final Variable_declaratorsContext variable_declarators() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1564); variable_declarator();
			setState(1569);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1566); variable_declarator();
				}
				}
				setState(1571);
				_errHandler.sync(this);
	...
	public final Variable_declaratorContext variable_declarator() throws RecognitionException {
		...
		try {
			...
			if (_la==ASSIGNMENT) {
				...
				setState(1574); variable_initializer();
				}
			}
	...
	public final Variable_initializerContext variable_initializer() throws RecognitionException {
		...
		try {
			...
			case OPEN_BRACE:
				enterOuterAlt(_localctx, 2);
				{
				setState(1578); array_initializer();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Member_nameContext member_name() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1585); namespace_or_type_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Formal_parameter_listContext formal_parameter_list() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1592); fixed_parameters();
				setState(1595);
				_la = _input.LA(1);
				if (_la==COMMA) {
					{
					setState(1593); match(COMMA);
					setState(1594); parameter_array();
					}
				}
		...
		try {
			...
			case 1:
				...
				if (((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & ((1L << (OUT - 71)) | (1L << (REF - 71)) | (1L << (THIS - 71)))) != 0)) {
					{
					setState(1610); parameter_modifier();
					}
				}

				setState(1613); arg_declaration();
				}
				break;
	...
	public final Parameter_arrayContext parameter_array() throws RecognitionException {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				setState(1619); attributes();
				}
			}

			setState(1622); match(PARAMS);
			setState(1623); array_type();
			setState(1624); identifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Accessor_declarationsContext accessor_declarations() throws RecognitionException {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				setState(1626); ((Accessor_declarationsContext)_localctx).attrs = attributes();
				}
			}
			...
			if (((((_la - 56)) & ~0x3f) == 0 && ((1L << (_la - 56)) & ((1L << (INTERNAL - 56)) | (1L << (PRIVATE - 56)) | (1L << (PROTECTED - 56)))) != 0)) {
				{
				setState(1629); ((Accessor_declarationsContext)_localctx).mods = accessor_modifier();
				}
			}
	...
	public final Get_accessor_declarationContext get_accessor_declaration() throws RecognitionException {
		...
		try {
			...
			if (((((_la - 56)) & ~0x3f) == 0 && ((1L << (_la - 56)) & ((1L << (INTERNAL - 56)) | (1L << (PRIVATE - 56)) | (1L << (PROTECTED - 56)))) != 0)) {
				{
				setState(1647); accessor_modifier();
				}
			}

			setState(1650); match(GET);
			setState(1651); accessor_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Set_accessor_declarationContext set_accessor_declaration() throws RecognitionException {
		...
		try {
			...
			if (((((_la - 56)) & ~0x3f) == 0 && ((1L << (_la - 56)) & ((1L << (INTERNAL - 56)) | (1L << (PRIVATE - 56)) | (1L << (PROTECTED - 56)))) != 0)) {
				{
				setState(1656); accessor_modifier();
				}
			}

			setState(1659); match(SET);
			setState(1660); accessor_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Accessor_modifierContext accessor_modifier() throws RecognitionException {
		...
		try {
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(1665); match(PROTECTED);
				setState(1666); match(INTERNAL);
				}
				break;
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(1667); match(INTERNAL);
				setState(1668); match(PROTECTED);
				}
				break;
			}
		}
	...
	public final Event_accessor_declarationsContext event_accessor_declarations() throws RecognitionException {
		...
		try {
			...
			case ADD:
				{
				setState(1678); match(ADD);
				setState(1679); block();
				setState(1680); remove_accessor_declaration();
				}
				break;
			case REMOVE:
				{
				setState(1682); match(REMOVE);
				setState(1683); block();
				setState(1684); add_accessor_declaration();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Remove_accessor_declarationContext remove_accessor_declaration() throws RecognitionException {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				setState(1694); attributes();
				}
			}

			setState(1697); match(REMOVE);
			setState(1698); block();
			}
		}
		catch (RecognitionException re) {
	...
	public final Overloadable_operatorContext overloadable_operator() throws RecognitionException {
		...
		try {
			...
			case 13:
				enterOuterAlt(_localctx, 13);
				{
				setState(1712); match(BITWISE_OR);
				}
				break;
			...
			case 15:
				enterOuterAlt(_localctx, 15);
				{
				setState(1714); match(OP_LEFT_SHIFT);
				}
				break;
	...
	public final Conversion_operator_declaratorContext conversion_operator_declarator() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(1725); match(OPERATOR);
			setState(1726); type();
			setState(1727); match(OPEN_PARENS);
			setState(1728); arg_declaration();
			setState(1729); match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Constructor_initializerContext constructor_initializer() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(1733); match(OPEN_PARENS);
			setState(1735);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (OUT - 65)) | (1L << (PARTIAL - 65)) | (1L << (REF - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
				{
				setState(1734); argument_list();
				}
			}

			setState(1737); match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Struct_interfacesContext struct_interfaces() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1743); match(COLON);
			setState(1744); interface_type_list();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Struct_bodyContext struct_body() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1746); match(OPEN_BRACE);
			setState(1750);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CLASS) | (1L << CONST) | (1L << DECIMAL) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << ENUM) | (1L << EQUALS) | (1L << EVENT) | (1L << EXPLICIT) | (1L << EXTERN) | (1L << FIXED) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << IMPLICIT) | (1L << INT) | (1L << INTERFACE) | (1L << INTERNAL) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (OVERRIDE - 65)) | (1L << (PARTIAL - 65)) | (1L << (PRIVATE - 65)) | (1L << (PROTECTED - 65)) | (1L << (PUBLIC - 65)) | (1L << (READONLY - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SEALED - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (STATIC - 65)) | (1L << (STRING - 65)) | (1L << (STRUCT - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNSAFE - 65)) | (1L << (USHORT - 65)) | (1L << (VIRTUAL - 65)) | (1L << (VOID - 65)) | (1L << (VOLATILE - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (OPEN_BRACKET - 65)))) != 0)) {
				{
				{
				setState(1747); struct_member_declaration();
				}
				}
				setState(1752);
				_errHandler.sync(this);
			...
			setState(1753); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Struct_member_declarationContext struct_member_declaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1758); all_member_modifiers();
				}
				break;
			}
			setState(1771);
			...
			case IDENTIFIER:
				{
				setState(1761); common_member_declaration();
				}
				break;
			case FIXED:
				{
				setState(1762); match(FIXED);
				setState(1763); type();
				setState(1765); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
					{
					{
					setState(1764); fixed_size_buffer_declarator();
					}
					}
					setState(1767); 
					_errHandler.sync(this);
	...
	public final Rank_specifierContext rank_specifier() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1785); match(OPEN_BRACKET);
			setState(1789);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
			...
			setState(1792); match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Array_initializerContext array_initializer() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(1794); match(OPEN_BRACE);
			setState(1806);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_BRACE - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
				{
				setState(1795); variable_initializer();
				setState(1800);
				_errHandler.sync(this);
				...
				while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						setState(1797); variable_initializer();
						}
						} 
					}
					setState(1802);
			...
			setState(1808); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Variant_type_parameter_listContext variant_type_parameter_list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1810); match(LT);
			setState(1811); variant_type_parameter();
			setState(1816);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1813); variant_type_parameter();
				}
				}
				setState(1818);
				_errHandler.sync(this);
	...
	public final Variant_type_parameterContext variant_type_parameter() throws RecognitionException {
		...
		try {
			...
			if (_la==IN || _la==OUT) {
				{
				setState(1824); variance_annotation();
				}
			}
	...
	public final Interface_baseContext interface_base() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1831); match(COLON);
			setState(1832); interface_type_list();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Interface_bodyContext interface_body() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1834); match(OPEN_BRACE);
			setState(1838);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << DECIMAL) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << EVENT) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (STRING - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNSAFE - 65)) | (1L << (USHORT - 65)) | (1L << (VOID - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (OPEN_BRACKET - 65)))) != 0)) {
				{
				{
				setState(1835); interface_member_declaration();
				}
				}
				setState(1840);
				_errHandler.sync(this);
			...
			setState(1841); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Interface_member_declarationContext interface_member_declaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					setState(1853); identifier();
					setState(1855);
					_la = _input.LA(1);
					if (_la==LT) {
						{
						setState(1854); type_parameter_list();
						}
					}

					setState(1857); match(OPEN_PARENS);
					setState(1859);
					_la = _input.LA(1);
					if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << DECIMAL) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (OBJECT - 67)) | (1L << (ON - 67)) | (1L << (ORDERBY - 67)) | (1L << (OUT - 67)) | (1L << (PARAMS - 67)) | (1L << (PARTIAL - 67)) | (1L << (REF - 67)) | (1L << (REMOVE - 67)) | (1L << (SBYTE - 67)) | (1L << (SELECT - 67)) | (1L << (SET - 67)) | (1L << (SHORT - 67)) | (1L << (STRING - 67)) | (1L << (THIS - 67)) | (1L << (UINT - 67)) | (1L << (ULONG - 67)) | (1L << (USHORT - 67)) | (1L << (VOID - 67)) | (1L << (WHEN - 67)) | (1L << (WHERE - 67)) | (1L << (YIELD - 67)) | (1L << (IDENTIFIER - 67)) | (1L << (OPEN_BRACKET - 67)))) != 0)) {
						{
						setState(1858); formal_parameter_list();
						}
					}

					setState(1861); match(CLOSE_PARENS);
					setState(1863);
					_la = _input.LA(1);
					if (_la==WHERE) {
						{
						setState(1862); type_parameter_constraints_clauses();
						}
					}

					setState(1865); match(SEMICOLON);
					}
					break;

				case 2:
					{
					setState(1867); identifier();
					setState(1868); match(OPEN_BRACE);
					setState(1869); interface_accessors();
					setState(1870); match(CLOSE_BRACE);
					}
					break;

				case 3:
					{
					setState(1872); match(THIS);
					setState(1873); match(OPEN_BRACKET);
					setState(1874); formal_parameter_list();
					setState(1875); match(CLOSE_BRACKET);
					setState(1876); match(OPEN_BRACE);
					setState(1877); interface_accessors();
					setState(1878); match(CLOSE_BRACE);
					}
					break;
				}
				}
			...
			case 2:
				...
				if (_la==UNSAFE) {
					{
					setState(1882); match(UNSAFE);
					}
				}

				setState(1885); match(VOID);
				setState(1886); identifier();
				setState(1888);
				_la = _input.LA(1);
				if (_la==LT) {
					{
					setState(1887); type_parameter_list();
					}
				}

				setState(1890); match(OPEN_PARENS);
				setState(1892);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << DECIMAL) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (OBJECT - 67)) | (1L << (ON - 67)) | (1L << (ORDERBY - 67)) | (1L << (OUT - 67)) | (1L << (PARAMS - 67)) | (1L << (PARTIAL - 67)) | (1L << (REF - 67)) | (1L << (REMOVE - 67)) | (1L << (SBYTE - 67)) | (1L << (SELECT - 67)) | (1L << (SET - 67)) | (1L << (SHORT - 67)) | (1L << (STRING - 67)) | (1L << (THIS - 67)) | (1L << (UINT - 67)) | (1L << (ULONG - 67)) | (1L << (USHORT - 67)) | (1L << (VOID - 67)) | (1L << (WHEN - 67)) | (1L << (WHERE - 67)) | (1L << (YIELD - 67)) | (1L << (IDENTIFIER - 67)) | (1L << (OPEN_BRACKET - 67)))) != 0)) {
					{
					setState(1891); formal_parameter_list();
					}
				}

				setState(1894); match(CLOSE_PARENS);
				setState(1896);
				_la = _input.LA(1);
				if (_la==WHERE) {
					{
					setState(1895); type_parameter_constraints_clauses();
					}
				}

				setState(1898); match(SEMICOLON);
				}
				break;

			case 3:
				{
				setState(1900); match(EVENT);
				setState(1901); type();
				setState(1902); identifier();
				setState(1903); match(SEMICOLON);
				}
				break;
			}
			}
	...
	public final Interface_accessorsContext interface_accessors() throws RecognitionException {
		...
		try {
			...
			case GET:
				{
				setState(1910); match(GET);
				setState(1911); match(SEMICOLON);
				setState(1917);
				_la = _input.LA(1);
				if (_la==SET || _la==OPEN_BRACKET) {
					...
					if (_la==OPEN_BRACKET) {
						{
						setState(1912); attributes();
						}
					}

					setState(1915); match(SET);
					setState(1916); match(SEMICOLON);
					}
				}
			...
			case SET:
				{
				setState(1919); match(SET);
				setState(1920); match(SEMICOLON);
				setState(1926);
				_la = _input.LA(1);
				if (_la==GET || _la==OPEN_BRACKET) {
					...
					if (_la==OPEN_BRACKET) {
						{
						setState(1921); attributes();
						}
					}

					setState(1924); match(GET);
					setState(1925); match(SEMICOLON);
					}
				}
	...
	public final Enum_bodyContext enum_body() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(1933); match(OPEN_BRACE);
			setState(1945);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BY) | (1L << DESCENDING) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << NAMEOF))) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & ((1L << (ON - 68)) | (1L << (ORDERBY - 68)) | (1L << (PARTIAL - 68)) | (1L << (REMOVE - 68)) | (1L << (SELECT - 68)) | (1L << (SET - 68)) | (1L << (WHEN - 68)) | (1L << (WHERE - 68)) | (1L << (YIELD - 68)) | (1L << (IDENTIFIER - 68)) | (1L << (OPEN_BRACKET - 68)))) != 0)) {
				{
				...
				while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						setState(1936); enum_member_declaration();
						}
						} 
					}
					setState(1941);
			...
			setState(1947); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Global_attribute_sectionContext global_attribute_section() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1957); match(OPEN_BRACKET);
			setState(1958); global_attribute_target();
			setState(1959); match(COLON);
			setState(1960); attribute_list();
			setState(1962);
			_la = _input.LA(1);
			if (_la==COMMA) {
				{
			...
			setState(1964); match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AttributesContext attributes() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(1970); attribute_section();
				}
				}
				setState(1973); 
				_errHandler.sync(this);
	...
	public final Attribute_sectionContext attribute_section() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1975); match(OPEN_BRACKET);
			setState(1979);
			switch ( getInterpreter().adaptivePredict(_input,236,_ctx) ) {
			case 1:
				{
				setState(1976); attribute_target();
				setState(1977); match(COLON);
				}
				break;
			}
			setState(1981); attribute_list();
			setState(1983);
			_la = _input.LA(1);
			if (_la==COMMA) {
				{
			...
			setState(1985); match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AttributeContext attribute() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1999); namespace_or_type_name();
			setState(2012);
			_la = _input.LA(1);
			if (_la==OPEN_PARENS) {
				{
				setState(2000); match(OPEN_PARENS);
				setState(2009);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
					{
					setState(2001); attribute_argument();
					setState(2006);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
						...
						setState(2003); attribute_argument();
						}
						}
						setState(2008);
						_errHandler.sync(this);
				...
				setState(2011); match(CLOSE_PARENS);
				}
			}
	...
	public final Attribute_argumentContext attribute_argument() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(2014); identifier();
				setState(2015); match(COLON);
				}
				break;
			}
			setState(2019); expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case IDENTIFIER:
				...
				while (_la==OPEN_BRACKET || _la==INTERR) {
					...
					case OPEN_BRACKET:
						{
						setState(2025); rank_specifier();
						}
						break;
					case INTERR:
						{
						setState(2026); match(INTERR);
						}
						break;
					default:
						throw new NoViableAltException(this);
				...
				setState(2032); match(STAR);
				}
				break;
			case VOID:
				enterOuterAlt(_localctx, 2);
				{
				setState(2034); match(VOID);
				setState(2035); match(STAR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Fixed_pointer_declaratorsContext fixed_pointer_declarators() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2038); fixed_pointer_declarator();
			setState(2043);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(2040); fixed_pointer_declarator();
				}
				}
				setState(2045);
				_errHandler.sync(this);
	...
	public final Fixed_pointer_declaratorContext fixed_pointer_declarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2046); identifier();
			setState(2047); match(ASSIGNMENT);
			setState(2048); fixed_pointer_initializer();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Fixed_pointer_initializerContext fixed_pointer_initializer() throws RecognitionException {
		...
		try {
			...
			case STACKALLOC:
				enterOuterAlt(_localctx, 2);
				{
				setState(2054); local_variable_initializer_unsafe();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Fixed_size_buffer_declaratorContext fixed_size_buffer_declarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2057); identifier();
			setState(2058); match(OPEN_BRACKET);
			setState(2059); expression();
			setState(2060); match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Local_variable_initializer_unsafeContext local_variable_initializer_unsafe() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2062); match(STACKALLOC);
			setState(2063); type();
			setState(2064); match(OPEN_BRACKET);
			setState(2065); expression();
			setState(2066); match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Right_arrowContext right_arrow() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2068); ((Right_arrowContext)_localctx).first = match(ASSIGNMENT);
			setState(2069); ((Right_arrowContext)_localctx).second = match(GT);
			setState(2070);
	...
	public final Right_shiftContext right_shift() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2072); ((Right_shiftContext)_localctx).first = match(GT);
			setState(2073); ((Right_shiftContext)_localctx).second = match(GT);
			setState(2074);
	...
	public final Right_shift_assignmentContext right_shift_assignment() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2076); ((Right_shift_assignmentContext)_localctx).first = match(GT);
			setState(2077); ((Right_shift_assignmentContext)_localctx).second = match(OP_GE);
			setState(2078);
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			case INTERPOLATED_VERBATIUM_STRING_START:
				enterOuterAlt(_localctx, 2);
				{
				setState(2081); string_literal();
				}
				break;
			case INTEGER_LITERAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(2082); match(INTEGER_LITERAL);
				}
				break;
			case HEX_INTEGER_LITERAL:
				enterOuterAlt(_localctx, 4);
				{
				setState(2083); match(HEX_INTEGER_LITERAL);
				}
				break;
			case REAL_LITERAL:
				enterOuterAlt(_localctx, 5);
				{
				setState(2084); match(REAL_LITERAL);
				}
				break;
			case CHARACTER_LITERAL:
				enterOuterAlt(_localctx, 6);
				{
				setState(2085); match(CHARACTER_LITERAL);
				}
				break;
			case NULL:
				enterOuterAlt(_localctx, 7);
				{
				setState(2086); match(NULL);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final String_literalContext string_literal() throws RecognitionException {
		...
		try {
			...
			case INTERPOLATED_REGULAR_STRING_START:
				enterOuterAlt(_localctx, 1);
				{
				setState(2091); interpolated_regular_string();
				}
				break;
			case INTERPOLATED_VERBATIUM_STRING_START:
				enterOuterAlt(_localctx, 2);
				{
				setState(2092); interpolated_verbatium_string();
				}
				break;
			case REGULAR_STRING:
				enterOuterAlt(_localctx, 3);
				{
				setState(2093); match(REGULAR_STRING);
				}
				break;
			case VERBATIUM_STRING:
				enterOuterAlt(_localctx, 4);
				{
				setState(2094); match(VERBATIUM_STRING);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Interpolated_regular_stringContext interpolated_regular_string() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2097); match(INTERPOLATED_REGULAR_STRING_START);
			setState(2101);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)) | (1L << (DOUBLE_CURLY_INSIDE - 131)) | (1L << (REGULAR_CHAR_INSIDE - 131)) | (1L << (REGULAR_STRING_INSIDE - 131)))) != 0)) {
				{
				{
				setState(2098); interpolated_regular_string_part();
				}
				}
				setState(2103);
				_errHandler.sync(this);
			...
			setState(2104); match(DOUBLE_QUOTE_INSIDE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Interpolated_verbatium_stringContext interpolated_verbatium_string() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2106); match(INTERPOLATED_VERBATIUM_STRING_START);
			setState(2110);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (PARTIAL - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)) | (1L << (DOUBLE_CURLY_INSIDE - 131)) | (1L << (VERBATIUM_DOUBLE_QUOTE_INSIDE - 131)) | (1L << (VERBATIUM_INSIDE_STRING - 131)))) != 0)) {
				{
				{
				setState(2107); interpolated_verbatium_string_part();
				}
				}
				setState(2112);
				_errHandler.sync(this);
			...
			setState(2113); match(DOUBLE_QUOTE_INSIDE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Interpolated_regular_string_partContext interpolated_regular_string_part() throws RecognitionException {
		...
		try {
			...
			case OP_DEC:
				enterOuterAlt(_localctx, 1);
				{
				setState(2115); interpolated_string_expression();
				}
				break;
			case DOUBLE_CURLY_INSIDE:
				enterOuterAlt(_localctx, 2);
				{
				setState(2116); match(DOUBLE_CURLY_INSIDE);
				}
				break;
			case REGULAR_CHAR_INSIDE:
				enterOuterAlt(_localctx, 3);
				{
				setState(2117); match(REGULAR_CHAR_INSIDE);
				}
				break;
			case REGULAR_STRING_INSIDE:
				enterOuterAlt(_localctx, 4);
				{
				setState(2118); match(REGULAR_STRING_INSIDE);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Interpolated_verbatium_string_partContext interpolated_verbatium_string_part() throws RecognitionException {
		...
		try {
			...
			case OP_DEC:
				enterOuterAlt(_localctx, 1);
				{
				setState(2121); interpolated_string_expression();
				}
				break;
			case DOUBLE_CURLY_INSIDE:
				enterOuterAlt(_localctx, 2);
				{
				setState(2122); match(DOUBLE_CURLY_INSIDE);
				}
				break;
			case VERBATIUM_DOUBLE_QUOTE_INSIDE:
				enterOuterAlt(_localctx, 3);
				{
				setState(2123); match(VERBATIUM_DOUBLE_QUOTE_INSIDE);
				}
				break;
			case VERBATIUM_INSIDE_STRING:
				enterOuterAlt(_localctx, 4);
				{
				setState(2124); match(VERBATIUM_INSIDE_STRING);
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			if (_la==COLON) {
				...
				do {
					{
					{
					setState(2136); match(FORMAT_STRING);
					}
					}
					setState(2139); 
					_errHandler.sync(this);
	...
	public final Class_definitionContext class_definition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2145); match(CLASS);
			setState(2146); identifier();
			setState(2148);
			_la = _input.LA(1);
			if (_la==LT) {
				{
				setState(2147); type_parameter_list();
				}
			}
			...
			if (_la==WHERE) {
				{
				setState(2153); type_parameter_constraints_clauses();
				}
			}

			setState(2156); class_body();
			setState(2158);
			_la = _input.LA(1);
			if (_la==SEMICOLON) {
				{
				setState(2157); match(SEMICOLON);
				}
			}
	...
	public final Struct_definitionContext struct_definition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2160); match(STRUCT);
			setState(2161); identifier();
			setState(2163);
			_la = _input.LA(1);
			if (_la==LT) {
				{
				setState(2162); type_parameter_list();
				}
			}
			...
			if (_la==COLON) {
				{
				setState(2165); struct_interfaces();
				}
			}
			...
			if (_la==WHERE) {
				{
				setState(2168); type_parameter_constraints_clauses();
				}
			}

			setState(2171); struct_body();
			setState(2173);
			_la = _input.LA(1);
			if (_la==SEMICOLON) {
				{
				setState(2172); match(SEMICOLON);
				}
			}
	...
	public final Interface_definitionContext interface_definition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2175); match(INTERFACE);
			setState(2176); identifier();
			setState(2178);
			_la = _input.LA(1);
			if (_la==LT) {
				{
				setState(2177); variant_type_parameter_list();
				}
			}
			...
			if (_la==WHERE) {
				{
				setState(2183); type_parameter_constraints_clauses();
				}
			}

			setState(2186); interface_body();
			setState(2188);
			_la = _input.LA(1);
			if (_la==SEMICOLON) {
				{
				setState(2187); match(SEMICOLON);
				}
			}
	...
	public final Enum_definitionContext enum_definition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2190); match(ENUM);
			setState(2191); identifier();
			setState(2193);
			_la = _input.LA(1);
			if (_la==COLON) {
				{
				setState(2192); enum_base();
				}
			}

			setState(2195); enum_body();
			setState(2197);
			_la = _input.LA(1);
			if (_la==SEMICOLON) {
				{
				setState(2196); match(SEMICOLON);
				}
			}
	...
	public final Delegate_definitionContext delegate_definition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2199); match(DELEGATE);
			setState(2200); return_type();
			setState(2201); identifier();
			setState(2203);
			_la = _input.LA(1);
			if (_la==LT) {
				{
				setState(2202); variant_type_parameter_list();
				}
			}

			setState(2205); match(OPEN_PARENS);
			setState(2207);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << DECIMAL) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (OBJECT - 67)) | (1L << (ON - 67)) | (1L << (ORDERBY - 67)) | (1L << (OUT - 67)) | (1L << (PARAMS - 67)) | (1L << (PARTIAL - 67)) | (1L << (REF - 67)) | (1L << (REMOVE - 67)) | (1L << (SBYTE - 67)) | (1L << (SELECT - 67)) | (1L << (SET - 67)) | (1L << (SHORT - 67)) | (1L << (STRING - 67)) | (1L << (THIS - 67)) | (1L << (UINT - 67)) | (1L << (ULONG - 67)) | (1L << (USHORT - 67)) | (1L << (VOID - 67)) | (1L << (WHEN - 67)) | (1L << (WHERE - 67)) | (1L << (YIELD - 67)) | (1L << (IDENTIFIER - 67)) | (1L << (OPEN_BRACKET - 67)))) != 0)) {
				{
				setState(2206); formal_parameter_list();
				}
			}

			setState(2209); match(CLOSE_PARENS);
			setState(2211);
			_la = _input.LA(1);
			if (_la==WHERE) {
				{
				setState(2210); type_parameter_constraints_clauses();
				}
			}

			setState(2213); match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Event_declarationContext event_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2215); match(EVENT);
			setState(2216); type();
			setState(2225);
			switch ( getInterpreter().adaptivePredict(_input,277,_ctx) ) {
			case 1:
				{
				setState(2217); variable_declarators();
				setState(2218); match(SEMICOLON);
				}
				break;

			case 2:
				{
				setState(2220); member_name();
				setState(2221); match(OPEN_BRACE);
				setState(2222); event_accessor_declarations();
				setState(2223); match(CLOSE_BRACE);
				}
				break;
			}
			}
	...
	public final Field_declarationContext field_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2227); variable_declarators();
			setState(2228); match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Property_declarationContext property_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2230); member_name();
			setState(2244);
			switch (_input.LA(1)) {
			case OPEN_BRACE:
				{
				setState(2231); match(OPEN_BRACE);
				setState(2232); accessor_declarations();
				setState(2233); match(CLOSE_BRACE);
				setState(2238);
				_la = _input.LA(1);
				if (_la==ASSIGNMENT) {
					{
					setState(2234); match(ASSIGNMENT);
					setState(2235); variable_initializer();
					setState(2236); match(SEMICOLON);
					}
				}
			...
			case ASSIGNMENT:
				{
				setState(2240); right_arrow();
				setState(2241); expression();
				setState(2242); match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Constant_declarationContext constant_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2246); match(CONST);
			setState(2247); type();
			setState(2248); constant_declarators();
			setState(2249); match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Indexer_declarationContext indexer_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2251); match(THIS);
			setState(2252); match(OPEN_BRACKET);
			setState(2253); formal_parameter_list();
			setState(2254); match(CLOSE_BRACKET);
			setState(2263);
			switch (_input.LA(1)) {
			case OPEN_BRACE:
				{
				setState(2255); match(OPEN_BRACE);
				setState(2256); accessor_declarations();
				setState(2257); match(CLOSE_BRACE);
				}
				break;
			case ASSIGNMENT:
				{
				setState(2259); right_arrow();
				setState(2260); expression();
				setState(2261); match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Destructor_definitionContext destructor_definition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2265); match(TILDE);
			setState(2266); identifier();
			setState(2267); match(OPEN_PARENS);
			setState(2268); match(CLOSE_PARENS);
			setState(2269); body();
			}
		}
		catch (RecognitionException re) {
	...
	public final Constructor_declarationContext constructor_declaration() throws RecognitionException {
		...
		try {
			...
			setState(2272); match(OPEN_PARENS);
			setState(2274);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << DECIMAL) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (OBJECT - 67)) | (1L << (ON - 67)) | (1L << (ORDERBY - 67)) | (1L << (OUT - 67)) | (1L << (PARAMS - 67)) | (1L << (PARTIAL - 67)) | (1L << (REF - 67)) | (1L << (REMOVE - 67)) | (1L << (SBYTE - 67)) | (1L << (SELECT - 67)) | (1L << (SET - 67)) | (1L << (SHORT - 67)) | (1L << (STRING - 67)) | (1L << (THIS - 67)) | (1L << (UINT - 67)) | (1L << (ULONG - 67)) | (1L << (USHORT - 67)) | (1L << (VOID - 67)) | (1L << (WHEN - 67)) | (1L << (WHERE - 67)) | (1L << (YIELD - 67)) | (1L << (IDENTIFIER - 67)) | (1L << (OPEN_BRACKET - 67)))) != 0)) {
				{
				setState(2273); formal_parameter_list();
				}
			}

			setState(2276); match(CLOSE_PARENS);
			setState(2278);
			_la = _input.LA(1);
			if (_la==COLON) {
				{
				setState(2277); constructor_initializer();
				}
			}
	...
	public final Method_declarationContext method_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2282); method_member_name();
			setState(2284);
			_la = _input.LA(1);
			if (_la==LT) {
				{
				setState(2283); type_parameter_list();
				}
			}
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << DECIMAL) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (OBJECT - 67)) | (1L << (ON - 67)) | (1L << (ORDERBY - 67)) | (1L << (OUT - 67)) | (1L << (PARAMS - 67)) | (1L << (PARTIAL - 67)) | (1L << (REF - 67)) | (1L << (REMOVE - 67)) | (1L << (SBYTE - 67)) | (1L << (SELECT - 67)) | (1L << (SET - 67)) | (1L << (SHORT - 67)) | (1L << (STRING - 67)) | (1L << (THIS - 67)) | (1L << (UINT - 67)) | (1L << (ULONG - 67)) | (1L << (USHORT - 67)) | (1L << (VOID - 67)) | (1L << (WHEN - 67)) | (1L << (WHERE - 67)) | (1L << (YIELD - 67)) | (1L << (IDENTIFIER - 67)) | (1L << (OPEN_BRACKET - 67)))) != 0)) {
				{
				setState(2287); formal_parameter_list();
				}
			}

			setState(2290); match(CLOSE_PARENS);
			setState(2292);
			_la = _input.LA(1);
			if (_la==WHERE) {
				{
				setState(2291); type_parameter_constraints_clauses();
				}
			}
			...
			case SEMICOLON:
				{
				setState(2294); method_body();
				}
				break;
			case ASSIGNMENT:
				{
				setState(2295); right_arrow();
				setState(2296); expression();
				setState(2297); match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Method_member_nameContext method_member_name() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(2303); match(DOUBLE_COLON);
				setState(2304); identifier();
				}
				break;
			}
			setState(2315);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==LT) {
						{
						setState(2308); type_argument_list();
						}
					}

					setState(2311); match(DOT);
					setState(2312); identifier();
					}
					} 
				}
				setState(2317);
	...
	public final Operator_declarationContext operator_declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2318); match(OPERATOR);
			setState(2319); overloadable_operator();
			setState(2320); match(OPEN_PARENS);
			setState(2321); arg_declaration();
			setState(2324);
			_la = _input.LA(1);
			if (_la==COMMA) {
				{
				setState(2322); match(COMMA);
				setState(2323); arg_declaration();
				}
			}

			setState(2326); match(CLOSE_PARENS);
			setState(2332);
			switch (_input.LA(1)) {
			case OPEN_BRACE:
			case SEMICOLON:
			...
			case ASSIGNMENT:
				{
				setState(2328); right_arrow();
				setState(2329); expression();
				setState(2330); match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Arg_declarationContext arg_declaration() throws RecognitionException {
		...
		try {
			...
			{
			setState(2334); type();
			setState(2335); identifier();
			setState(2338);
			_la = _input.LA(1);
			if (_la==ASSIGNMENT) {
				{
				setState(2336); match(ASSIGNMENT);
				setState(2337); expression();
				}
			}
	...
	public final Method_invocationContext method_invocation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2340); match(OPEN_PARENS);
			setState(2342);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (OUT - 65)) | (1L << (PARTIAL - 65)) | (1L << (REF - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
				{
				setState(2341); argument_list();
				}
			}

			setState(2344); match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Object_creation_expressionContext object_creation_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(2346); match(OPEN_PARENS);
			setState(2348);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG) | (1L << NAMEOF))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NEW - 65)) | (1L << (NULL - 65)) | (1L << (OBJECT - 65)) | (1L << (ON - 65)) | (1L << (ORDERBY - 65)) | (1L << (OUT - 65)) | (1L << (PARTIAL - 65)) | (1L << (REF - 65)) | (1L << (REMOVE - 65)) | (1L << (SBYTE - 65)) | (1L << (SELECT - 65)) | (1L << (SET - 65)) | (1L << (SHORT - 65)) | (1L << (SIZEOF - 65)) | (1L << (STRING - 65)) | (1L << (THIS - 65)) | (1L << (TRUE - 65)) | (1L << (TYPEOF - 65)) | (1L << (UINT - 65)) | (1L << (ULONG - 65)) | (1L << (UNCHECKED - 65)) | (1L << (USHORT - 65)) | (1L << (WHEN - 65)) | (1L << (WHERE - 65)) | (1L << (YIELD - 65)) | (1L << (IDENTIFIER - 65)) | (1L << (LITERAL_ACCESS - 65)) | (1L << (INTEGER_LITERAL - 65)) | (1L << (HEX_INTEGER_LITERAL - 65)) | (1L << (REAL_LITERAL - 65)) | (1L << (CHARACTER_LITERAL - 65)) | (1L << (REGULAR_STRING - 65)) | (1L << (VERBATIUM_STRING - 65)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 65)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 65)) | (1L << (OPEN_PARENS - 65)))) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & ((1L << (PLUS - 131)) | (1L << (MINUS - 131)) | (1L << (STAR - 131)) | (1L << (AMP - 131)) | (1L << (BANG - 131)) | (1L << (TILDE - 131)) | (1L << (OP_INC - 131)) | (1L << (OP_DEC - 131)))) != 0)) {
				{
				setState(2347); argument_list();
				}
			}

			setState(2350); match(CLOSE_PARENS);
			setState(2352);
			_la = _input.LA(1);
			if (_la==OPEN_BRACE) {
				{
				setState(2351); object_or_collection_initializer();
				}
			}
	...
	private boolean right_shift_sempred(Right_shiftContext _localctx, int predIndex) {
		switch (predIndex) {
		case 1: return (((Right_shiftContext)_localctx).first!=null?((Right_shiftContext)_localctx).first.getTokenIndex():0) + 1 == (((Right_shiftContext)_localctx).second!=null?((Right_shiftContext)_localctx).second.getTokenIndex():0);
		}
		return true;
	}
	private boolean right_arrow_sempred(Right_arrowContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0: return (((Right_arrowContext)_localctx).first!=null?((Right_arrowContext)_localctx).first.getTokenIndex():0) + 1 == (((Right_arrowContext)_localctx).second!=null?((Right_arrowContext)_localctx).second.getTokenIndex():0);
		}
		return true;
	}
	private boolean right_shift_assignment_sempred(Right_shift_assignmentContext _localctx, int predIndex) {
		switch (predIndex) {
		case 2: return (((Right_shift_assignmentContext)_localctx).first!=null?((Right_shift_assignmentContext)_localctx).first.getTokenIndex():0) + 1 == (((Right_shift_assignmentContext)_localctx).second!=null?((Right_shift_assignmentContext)_localctx).second.getTokenIndex():0);
		}
		return true;
	}
